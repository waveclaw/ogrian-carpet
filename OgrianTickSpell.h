...
public:
	...
	virtual void cast(Vector3 pos, Vector3 dir)
	{
		...
		TickSummonSpellThing* thing = new TickSummonSpellThing(0, pos,dir);
		Physics::getSingleton().addThing(thing);
	}

	virtual String getReadyMaterial() { return String("Ogrian/SpellIcon/Tick/Ready"); }; 

	virtual String getEnabledMaterial() { return String("Ogrian/SpellIcon/Tick/Enabled"); }; 

	virtual String getDisabledMaterial() { return String("Ogrian/SpellIcon/Tick/Disabled"); }; 
